...
Each month the agenda is community-generated. Have a topic? [DM us on Twitter](https://x.com/BTCBuildersClub) or submit a pull request to the relevent event file under the `meetups` folder.
...
The meetup will occur at Capital Factory every third Monday of the month. Follow [@BTCBuildersClub](https://x.com/BTCBuildersClub) for updates. Let’s get ₿uilding!

Event details on [website.](https://bitcoinbuildersatx.com)
